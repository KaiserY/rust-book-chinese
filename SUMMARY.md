 ...
 * [4.7.所有权](content/Ownership 所有权.md)
 * [4.8.引用和借用](content/References and Borrowing 引用和借用.md)
 * [4.9.生命周期](content/Lifetimes 生命周期.md)
 * [4.10.可变性](content/Mutability 可变性.md)
 * [4.11.结构体](content/Structs 结构体.md)
 * [4.12.枚举](content/Enums 枚举.md)
 * [4.13.匹配](content/Match 匹配.md)
 * [4.14.模式](content/Patterns 模式.md)
 * [4.15.方法语法](content/Method Syntax 方法语法.md)
 * [4.16.Vectors](content/Vectors.md)
