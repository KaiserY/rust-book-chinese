...
> [lifetimes.md](https://github.com/rust-lang/book/blob/master/first-edition/src/lifetimes.md)
> <br>
...
叫做`static`的生命周期是特殊的。它代表某样东西具有横跨整个程序的生命周期。大部分 Rust 程序员当他们处理字符串时第一次遇到`'static`：
