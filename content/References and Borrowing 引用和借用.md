...
> [references-and-borrowing.md](https://github.com/rust-lang/book/blob/master/first-edition/src/references-and-borrowing.md)
> <br>
...
当引用在它引用的变量**之前**声明会导致类似的问题。这是因为同一作用域中的资源以他们声明相反的顺序被释放：
